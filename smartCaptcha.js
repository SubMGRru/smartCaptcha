//РЎРєСЂРёРїС‚РѕРІР°СЏ С‡Р°СЃС‚СЊ "СѓРјРЅРѕР№ РєР°РїС‡Рё". Р’РµСЂСЃРёСЏ: 00.1. РђРІС‚РѕСЂ: Virabyan Aram (t.me/aramtop)

//РЈРґР°Р»СЏРµРј СѓР¶Рµ СЃСѓС‰РµСЃС‚РІСѓСЋС‰РёРµ С‚РѕРєРµРЅС‹, РІРІРёРґСѓ РЅРѕРІРѕР№ СЃРµСЃСЃРёРё
localStorage.removeItem('smartcaptcha_solutionkey');

//РџРµСЂРµРґР°РµРј СЃС‚РёР»Рё РґР»СЏ РєСЂР°СЃРёРІРѕРіРѕ РІРёРґР° РєР°РїС‡Рё Рё РµРµ РїРѕР·РёС†РёРѕРЅРёСЂРѕРІР°РЅРёСЏ
...
//Р”РѕР±Р°РІР»СЏРµРј РІ РєРѕРґ СЃС‚СЂР°РЅРёС†С‹ "РєР°СЂРєР°СЃ" РєР°РїС‡Рё
...
smartCaptcha_blueprintModel.innerHTML = `
    <div class="smartCamptcha_Zipped" style="-moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none;" unselectable="on" onselectstart="return false;" onmousedown="return false;" id="smartCamptcha_Zipped">
      <div class="smartCaptcha_Element" id="smartCaptcha_Element_Interact">
        <button class="smartCaptcha_requested_Close" id="smartCaptcha_requested_Close">вњ–</button>
        <p lno="0">Loading..</p>
      </div>
    </div>`;
...
//РРЅРёС†РёР°Р»РёР·Р°С†РёСЏ РєРѕРґР° Р±Р»РѕРєР° РєР°РїС‡Рё (HTML)
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("smartCaptcha_Element_Interact").innerHTML = `
              <button class="smartCaptcha_requested_Close" id="smartCaptcha_requested_Close">вњ–</button>
              <p lno="0">РџРѕРІРµСЂРЅРёС‚Рµ РёР·РѕР±СЂР°Р¶РµРЅРёРµ С‚Р°Рє, С‡С‚РѕР±С‹ РѕРЅРѕ Р±С‹Р»Рѕ СЂР°СЃРїРѕР»РѕР¶РµРЅРѕ РєРѕСЂСЂРµРєС‚РЅРѕ</p>
              ...
              <button class="smartCaptcha_requested_NextPositive" id="smartCaptcha_checkInput" lno="1">РџСЂРѕРІРµСЂРёС‚СЊ</button>
            `;
            //РќР°С‡РёРЅР°РµРј СЃР»СѓС€Р°С‚СЊ СЃРѕР±С‹С‚РёРµ РґР»СЏ Р·Р°РєСЂС‹С‚РёСЏ РѕРєРЅР° РєР°РїС‡Рё
            smartCaptcha_requested_Close.onclick = function() {
                smartcaptcha_Block.style.display = "none";
              };
            //РќР°С‡РёРЅР°РµРј СЃР»СѓС€Р°С‚СЊ СЃРѕР±С‹С‚РёСЏ РґРІРёР¶РµРЅРёСЏ РєРЅРѕРїРѕРє
            ...
            //РћР¶РёРґР°РµРј СЃРѕР±С‹С‚РёРµ РЅР°Р¶Р°С‚РёСЏ РєРЅРѕРїРєРё РґР»СЏ РїСЂРѕРІРµСЂРєРё РїСЂР°РІРёР»СЊРЅРѕСЃС‚Рё Рё Р·Р°РІРµСЂС€РµРЅРёСЏ
                ...
                xhr2.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if(smartCaptcha_StatusOfResolv == 1){
                            ...
                            //РќР°С‡РёРЅР°РµРј СЃР»СѓС€Р°С‚СЊ СЃРѕР±С‹С‚РёРµ РґР»СЏ Р·Р°РєСЂС‹С‚РёСЏ РѕРєРЅР° РєР°РїС‡Рё РїРѕСЃР»Рµ СѓСЃРїРµС…Р°
                            smartCaptcha_requested_Close.onclick = function() {
                                smartcaptcha_Block.style.display = "none";
                              };
                        } else {
                ...
                if(correct_rotationForProceed > 180 || correct_rotationForProceed < -180){
                	correct_rotationForProceed = correct_rotationForProceed%180;
                }
                if(correct_rotationForProceed < 0){
                	correct_rotationForProceed = correct_rotationForProceed*-1;
                }
               	alert(correct_rotationForProceed);
